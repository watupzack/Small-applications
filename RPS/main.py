...
def button_clicked(player_choice):
    ...
    if player_choice == "Rock":
        if computer_choice == "Rock":
            game_progess.set("Draw")
        elif computer_choice == "Paper":
            game_progess.set("Rock    vs    Paper\nPaper wins")
            computer_score.set("Computer\n" + str(int(computer_score.get()[9:]) + 1))
        elif computer_choice == "Scissors":
            game_progess.set("Rock    vs    Scissors\nRock wins")
            player_score.set("Player\n" + str(int(player_score.get()[7:]) + 1))
    elif player_choice == "Paper":
        if computer_choice == "Rock":
            game_progess.set("Paper    vs    Rock\nPaper wins")
            player_score.set("Player\n" + str(int(player_score.get()[7:]) + 1))
        elif computer_choice == "Paper":
            game_progess.set("Draw")
        elif computer_choice == "Scissors":
            game_progess.set("Paper    vs    Scissors\nScissors win")
            computer_score.set("Computer\n" + str(int(computer_score.get()[9:]) + 1))
    elif player_choice == "Scissors":
        if computer_choice == "Rock":
            game_progess.set("Scissors    vs    Rock\nRock wins")
            computer_score.set("Computer\n" + str(int(computer_score.get()[9:]) + 1))
        elif computer_choice == "Paper":
            game_progess.set("Scissors    vs    Paper\nScissors win")
            player_score.set("Player\n" + str(int(player_score.get()[7:]) + 1))
        elif computer_choice == "Scissors":
            game_progess.set("Draw")
...
game_progess = tkinter.StringVar()
player_score.set("Player\n0")
computer_score.set("Computer\n0")
...
game_label = tkinter.Label(window, textvariable=game_progess)
